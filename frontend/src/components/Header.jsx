          ...
          <Link to="/" className="flex items-center group">
            <div className="relative overflow-hidden">
              <img 
                src="/logo.png" 
                alt="Fit Aura" 
                className={`h-10 md:h-12 w-auto object-contain transition-transform duration-500 group-hover:scale-110 ${scrolled ? 'scale-90' : ''}`} 
              />
              <div className="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-white/30 to-amber-500/0 -translate-x-full group-hover:animate-shimmer" />
            </div>
          </Link>
