        ...
        <div className="space-y-8">
          ...
          <section id="acceptance">
            ...
            <p className="text-gray-700 mb-4">
              By accessing and using the MBABAZI CLOSET website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>
          </section>
          ...
          <section id="license">
            ...
            <p className="text-gray-700 mb-4">
              Permission is granted to temporarily download one copy of the materials (information or software) on MBABAZI CLOSET website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
          ...
          <section id="disclaimer">
            ...
            <p className="text-gray-700 mb-4">
              The materials on MBABAZI CLOSET website are provided "as is". MBABAZI CLOSET makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
            </p>
          </section>
          ...
          <section id="limitations">
            ...
            <p className="text-gray-700 mb-4">
              In no event shall MBABAZI CLOSET or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on MBABAZI CLOSET website, even if MBABAZI CLOSET or an authorized representative has been notified orally or in writing of the possibility of such damage.
            </p>
          </section>
          ...
          <section id="accuracy">
            ...
            <p className="text-gray-700 mb-4">
              The materials appearing on MBABAZI CLOSET website could include technical, typographical, or photographic errors. MBABAZI CLOSET does not warrant that any of the materials on our website are accurate, complete, or current. MBABAZI CLOSET may make changes to the materials contained on our website at any time without notice.
            </p>
          </section>
          ...
          <section id="links">
            ...
            <p className="text-gray-700 mb-4">
              MBABAZI CLOSET has not reviewed all of the sites linked to our website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by MBABAZI CLOSET of the site. Use of any such linked website is at the user's own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              MBABAZI CLOSET may revise these Terms and Conditions for its website at any time without notice. By using this website, you are agreeing to be bound by the then current version of these Terms and Conditions.
            </p>
          </section>
          ...
          <section className="bg-gray-50 p-8 rounded-lg mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <a href="mailto:support@mbabazicloset.rw" className="text-amber-600 hover:underline">
